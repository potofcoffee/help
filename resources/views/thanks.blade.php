<!doctype html>
<html class="fontawesome-i2svg-active fontawesome-i2svg-complete" lang="de"><head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <meta name="description" content="">
    <meta name="author" content="">
    <title>Wir helfen Nachbarn</title>
    ...
    <div class="container h-100">
        <div class="row h-100 align-items-center justify-content-center text-center">
            <div class="col-lg-10 align-self-end">
                <h1 class="text-uppercase text-white font-weight-bold">Herzlichen Dank!</h1>
                <hr class="divider my-4">
            </div>
            <div class="col-lg-8 align-self-baseline" style="font-size: 2em;">
                <p class="text-white-75 font-weight-bold mb-5">Deine Anfrage ist bei uns eingegangen.<br />Wir melden uns, sobald es etwas Neues gibt.</p>
                <a class="btn btn-primary btn-xl js-scroll-trigger mb-2" href="{{ route('cityWelcome', $city) }}">Zurück zum Anfang</a>
            </div>
        </div>
    </div>
</header>
...
<footer class="bg-light py-5">
    <div class="container"><div class="small text-center text-muted">Copyright © 2020 - <a href="https://www.tailfingen-evangelisch.de" target="_blank">Evangelische Kirchengemeinde Tailfingen</a></div></div>
</footer>
<!-- Bootstrap core JS-->
